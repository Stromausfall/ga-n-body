...
class NBodyExperimentArgumentDTOTest extends Specification {
    ...
    void "ToNBodyExperimentArgument - testing to and from"() {
        given:
            NBodyExperimentArgumentDTO classUnderTest = new NBodyExperimentArgumentDTO()
        ...
        when:
            NBodyExperimentArgument result =
                    NBodyExperimentArgumentDTO.from(
                            classUnderTest.toNBodyExperimentArgument())
                            .toNBodyExperimentArgument()
