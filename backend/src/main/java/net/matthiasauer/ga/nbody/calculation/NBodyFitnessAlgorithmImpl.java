...
@Component
public class NBodyFitnessAlgorithmImpl implements NBodyFitnessAlgorithm {
    ...
    @Autowired
    public NBodyFitnessAlgorithmImpl(NBodyFitnessUpdateBodyAlgorithm updateBodyPosition, NBodyFitnessTerminationAlgorithm terminationAlgorithm) {
